...
export default function landing(props){
    return(
        ...
        <div className="bg-amber-100">
            <div className="mt-10 ml-4 flex text-2xl font-sans font-bold ">
                {props.a}<svg width="30" height="30
                " viewBox="0 0 41 47" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className="mt-2 ml-4 flex text-2xl font-sans font-bold ">
            REBAHAN
            </div>
            PARTNER
        </div>
