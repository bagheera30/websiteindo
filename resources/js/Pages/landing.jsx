...
export default function landing(props) {
    return (
        <>
            ...
            <div className="my-20  mx-10 text-2xl font-serif ">
                <h1 className="my-10  mx-10 text-6xl font-bold ">
                    <p className="flex">{props.a}<svg width="80" height="80" viewBox="0 0 41 47" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <p className="mt-2">{props.b}</p>
                    <p className="mt-2">{props.c}</p>
                </h1>
                <h2>
                    <p>Your rebahan partner is a new way  manage and notify you about</p>
                    <p> your tasks. Not just it, we also helps you to lighten your mood, </p>
                    <p> motivate, and support you to work on better time management.</p>
                </h2>
            </div>
